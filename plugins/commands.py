...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://telegram.me/z_harbour')
            ],
            [
                InlineKeyboardButton('🍿 24×7 Movies🍿', url=f"https://telegram.me/blackest_harbour"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://telegram.me/blackest_harbour"),
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/mdisk_bots')
            ],[
